...
export const Home = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="fixed top-0 left-0 w-full z-10 shadow-neutral-600 shadow-md dark:shadow-md dark:shadow-neutral-300">
        <h1
      ...
      >
        <div className="flex flex-wrap justify-center mx-4 gap-2 p-4 mt-20">
      ...
      {toastStatus && (
        <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-[9999]">
          <Fade triggerOnce>
            <div
              className={`p-[30px] font-bold fixed top-[80px] right-[10px] w-[280px] rounded-2xl pointer-events-auto transition-colors ${
                theme === "dark"
